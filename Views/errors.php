...
<body>
    <div class="app app-error align-content-stretch d-flex flex-wrap">
        <div class="app-error-info">
            <h5>Oops!</h5>
            <span>Parece que la página que buscas ya no existe.
                Haremos todo lo posible para solucionar esto pronto..</span>
            <a href="<?php echo BASE_URL . 'admin'; ?>" class="btn btn-dark">Ir al panel de control</a>
        </div>
