                ...
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel"  id="servicios" name="servicios" class="form-control" placeholder="Escribe el servicio, Señaletica,Toldos,Pintar guarnciones o Paredes,Mantenimineto Baños,Gardineria" value="<?php echo $usuario['servicios'];?>" required>
