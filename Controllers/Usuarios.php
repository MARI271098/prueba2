    ...
    public function cambiarPass()
    {
        ...
        if (empty($actual) || empty($nueva) || empty($confirmar)) {
            ...
            if ($nueva != $confirmar) {
                ...
                if (password_verify($actual, $consulta['clave'])) {                                       //password_verify — Comprueba que la contraseña coincida con un hash
                    $hash = password_hash($nueva, PASSWORD_DEFAULT);                                      //password_hash-Crea un hash de contraseña // utiliza el algoritmo bcrypt por default una contraseña encriptada
